...
/* 
 * read_elf_header - reads the header file
 * @fd: the file descriptor of the ELF file
 * @header: the adress of header file
...
/*
 * validate_elf_file - validates the identity of the Elf header file
 * @header: the adress of header file
 * Description: If the file cannot be closed - exit code 99
 */
